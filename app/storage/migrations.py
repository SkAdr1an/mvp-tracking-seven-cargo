...
def _migration_script(connection: sqlite3.Connection) -> str:
    ...
    scripts.append(
        (MIGRATIONS_DIRECTORY / "016_weekly_programming.sql").read_text(encoding="utf-8")
    )
    alterations: list[str] = []
    expected_columns = {
        "driver_profiles": {
            "identity_status": "ALTER TABLE driver_profiles ADD COLUMN identity_status TEXT NOT NULL DEFAULT 'PENDING'",
            "emergency_phone": "ALTER TABLE driver_profiles ADD COLUMN emergency_phone TEXT",
            "client_operation": "ALTER TABLE driver_profiles ADD COLUMN client_operation TEXT",
            "routes_json": "ALTER TABLE driver_profiles ADD COLUMN routes_json TEXT NOT NULL DEFAULT '[]'",
            "vehicle_profile": "ALTER TABLE driver_profiles ADD COLUMN vehicle_profile TEXT",
            "master_status": "ALTER TABLE driver_profiles ADD COLUMN master_status TEXT",
            "registration_date": "ALTER TABLE driver_profiles ADD COLUMN registration_date TEXT",
        },
        "driver_trip_history": {
