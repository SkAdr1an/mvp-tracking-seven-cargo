...
export interface DriverHistorySummary { id:string;cpf?:string|null;name:string;phone?:string|null;total_trips:number;finished_trips:number;active_trips:number;pending_evaluations:number;last_trip_at?:string|null }
export interface DriverHistoryTrip { trip_key:string;provider_trip_id?:string|null;driver_id:string;plate:string;route_id?:string|null;route_name?:string|null;origin_name?:string|null;destination_name?:string|null;customer?:string|null;status:string;started_at?:string|null;finished_at?:string|null;automatic_punctuality:string;considered_punctuality?:string|null;evaluation_status:string }
