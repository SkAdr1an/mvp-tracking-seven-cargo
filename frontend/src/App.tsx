...
import './weekly-programming.css'
import './driver-master.css'
import './trafegus-history.css'
  ...
  return <SessionContext.Provider value={session}><div className="app-shell">
    ...
    <main className="main-content">
      ...
      <div className="page-content">
        ...
        {page === 'driver-master' && hasPermission(session,'drivers:read') && <DriverMaster />}
        {page === 'weekly-programming' && hasPermission(session,'trips:read') && <WeeklyProgramming />}
