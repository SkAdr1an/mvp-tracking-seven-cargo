...
test('alerts are ordered nearest first and include normal demo climate', () => { assert.match(component, /sort\(\(left, right\)/); assert.match(component, /CLIMA_NORMAL/); assert.match(component, /Condição climática normal/) })
